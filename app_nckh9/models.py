...
class InfoStudent(models.Model):
    khoaHoc = models.FloatField(default=2023)
    maSV = models.FloatField(unique=True)
    ...
    phoneCoVan = models.FloatField(blank=True, null=True)
...
class SinhVienTDG(models.Model):
    maSV = models.FloatField()
    tenSV = models.CharField(max_length=255)
    lopSV = models.CharField(max_length=255)
    dob = models.DateField()
    khoaSV = models.CharField(max_length=255)
    khoaHoc = models.FloatField()
    kqHocTap = models.FloatField()
    diemNCKH = models.FloatField()
    ...
    thanhtichHoatDong = models.FloatField()
    ...
    thanhvienBCS = models.FloatField()
    ...
    drl_tongket = models.FloatField(default=0)
...
class TeacherManager(models.Model):
    allClass = models.FloatField()
    allStudent = models.FloatField()
    countdown = models.DateTimeField()

class Analysts(models.Model):
    allStudent = models.FloatField()
    diemTB = models.FloatField()
    needImprove = models.FloatField() 
...
class NofiticationManager(models.Model):
    allNotification = models.FloatField()
    countdown = models.DateTimeField()
...
class HistoryPoint(models.Model):
    ...
    tenSV = models.CharField(max_length=255)
    maSV = models.FloatField()
    hocky1 = models.FloatField(blank=True, null=True)
    hocky2 = models.FloatField(blank=True, null=True)
    hocky3 = models.FloatField(blank=True, null=True)
    hocky4 = models.FloatField(blank=True, null=True)
    hocky5 = models.FloatField(blank=True, null=True)
    hocky6 = models.FloatField(blank=True, null=True)
    hocky7 = models.FloatField(blank=True, null=True)
    hocky8 = models.FloatField(blank=True, null=True)
    hocky9 = models.FloatField(blank=True, null=True)
    hocky10 = models.FloatField(blank=True, null=True)    
    hocky11 = models.FloatField(blank=True, null=True)
    hocky12 = models.FloatField(blank=True, null=True)
    hocky13 = models.FloatField(blank=True, null=True)
    hocky14 = models.FloatField(blank=True, null=True)
    hocky15 = models.FloatField(blank=True, null=True)
    hocky16 = models.FloatField(blank=True, null=True)
    hocky17 = models.FloatField(blank=True, null=True)
    hocky18 = models.FloatField(blank=True, null=True)
    hocky19 = models.FloatField(blank=True, null=True)
    hocky20 = models.FloatField(blank=True, null=True)
...
class AsyncSyncTask(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
    progress = models.FloatField(default=0)
    total_records = models.FloatField(null=True, blank=True)
    processed_records = models.FloatField(default=0)
    failed_records = models.FloatField(default=0)
...
class LopHoc(models.Model):
    ...
    khoa_hoc = models.FloatField(verbose_name="Khóa học")
...
class HocKy(models.Model):
    ...
    nam_hoc = models.FloatField()
    hoc_ky = models.FloatField(choices=[(1, "Học kỳ 1"), (2, "Học kỳ 2")])
...
class Rules(models.Model):
    ...
    max_points = models.FloatField(default=0, verbose_name="Điểm tối đa")
    order = models.FloatField(default=0, verbose_name="Thứ tự hiển thị")
